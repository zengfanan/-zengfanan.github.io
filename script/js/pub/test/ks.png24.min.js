define(function (a, b, c) {
	var d = {
		...
		readPropertyChange : function () {
			...
			if (a = event.srcElement, a.vmlInitiated) {
				if ((-1 != event.propertyName.search("background") || -1 != event.propertyName.search("border")) && d.applyVML(a), "style.display" == event.propertyName) {
					b = "none" == a.currentStyle.display ? "none" : "block";
					for (c in a.vml)
						a.vml.hasOwnProperty(c) && (a.vml[c].shape.style.display = b)
				}
				-1 != event.propertyName.search("filter") && d.vmlOpacity(a)
			}
		},
		...
		fix : function (a) {
			if (this.screenStyleSheet) {
				var b,
				c;
				for (b = a.split(","), c = 0; c < b.length; c++)
					this.screenStyleSheet.addRule(b[c], "behavior:expression(DD_belatedPNG.fixPng(this))")
			}
		},
		applyVML : function (a) {
		...
		copyImageBorders : function (a) {
			...
			for (c in b)
				b.hasOwnProperty(c) && (a.vml.color.shape.style[c] = a.currentStyle[c])
		},
		vmlFill : function (a) {
			if (a.currentStyle) {
				var b,
				...
				b = a.currentStyle;
				for (e in a.vml)
					a.vml.hasOwnProperty(e) && (a.vml[e].shape.style.zIndex = b.zIndex);
				a.runtimeStyle.backgroundColor = "",
				a.runtimeStyle.backgroundImage = "",
				c = !0,
				("none" != b.backgroundImage || a.isImg) && (a.isImg ? a.vmlBg = a.src : (a.vmlBg = b.backgroundImage, a.vmlBg = a.vmlBg.substr(5, a.vmlBg.lastIndexOf('")') - 5)), d = this, d.imgSize[a.vmlBg] || (f = document.createElement("img"), d.imgSize[a.vmlBg] = f, f.className = d.ns + "_sizeFinder", f.runtimeStyle.cssText = "behavior:none; position:absolute; left:-10000px; top:-10000px; border:none; margin:0; padding:0;", g = function () {
						this.width = this.offsetWidth,
						this.height = this.offsetHeight,
						d.vmlOffsets(a)
					}, f.attachEvent("onload", g), f.src = a.vmlBg, f.removeAttribute("width"), f.removeAttribute("height"), document.body.insertBefore(f, document.body.firstChild)), a.vml.image.fill.src = a.vmlBg, c = !1),
				a.vml.image.fill.on = !c,
		...
		vmlOffsets : function (a) {
			...
			if (b = a.currentStyle, c = {
				...
				f.X = parseInt(b.paddingLeft, 10) + 1, f.Y = parseInt(b.paddingTop, 10) + 1;
			else
				for (j in f)
					f.hasOwnProperty(j) && this.figurePercentage(f, c, j, b["backgroundPosition" + j]);
			a.vml.image.fill.position = f.X / c.W + "," + f.Y / c.H,
			g = b.backgroundRepeat,
			h = {
				T : 1,
				R : c.W + d,
				B : c.H,
		...
		figurePercentage : function (a, b, c, d) {
			...
			return a[c] = Math.ceil(f ? b[e ? "W" : "H"] * a[c] - b[e ? "w" : "h"] * a[c] : parseInt(d, 10)),
			a[c] % 2 === 0 && a[c]++,
			a[c]
		},
		fixPng : function (a) {
			...
			if ("BODY" != a.nodeName && "TD" != a.nodeName && "TR" != a.nodeName) {
				if (a.isImg = !1, "IMG" == a.nodeName) {
					if (-1 == a.src.toLowerCase().search(/\.png$/))
						return;
					a.isImg = !0,
					a.style.visibility = "hidden"
				} else if (-1 == a.currentStyle.backgroundImage.toLowerCase().search(".png"))
					return;
				b = d,
				a.vml = {
					color : {},
				...
				for (f in a.vml)
					if (a.vml.hasOwnProperty(f)) {
						for (g in c)
							c.hasOwnProperty(g) && (e = b.ns + ":" + g, a.vml[f][g] = document.createElement(e));
						a.vml[f].shape.stroked = !1,
						a.vml[f].shape.appendChild(a.vml[f].fill),
						a.parentNode.insertBefore(a.vml[f].shape, a)
					}
	...
	d.createVmlNameSpace(),
	d.createVmlStyleSheet(),
	window.DD_belatedPNG = d,
	c.exports = d
});
